...
def get_data(
    ...
    assert data_src in ['unstructured','earnings_calls','marker_pdf'], "The valid data sources are ['unstructured','earnings_calls','marker_pdf']"
    
    if 'marker_pdf' in data_src:
        # subprocess.run(["ls", "-l"])
